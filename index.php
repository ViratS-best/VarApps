...
<body>
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="https://github.com/ViratS-best/VarCart">Code</a>
            <!-- Add more links as needed -->
        </nav>
    </header>

    <div class="hero-row">
        <img src="poo-removebg-preview.png" alt="Mascot" class="hero-img">
        <section class="home">
            <div class="home-content">
                <h1>Welcome to VarCart</h1>
